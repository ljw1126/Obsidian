...
- [개발자로  성장하는 데 필요한 것 어떤 태도일까? | 우아한 형제들 출신 멘토님](https://f-lab.kr/blog/250610-devclub)
	- 테스트가 습관이 될때까지, 그리고 설계에 대한 불안감이 해소될때까지
- [대용량 서비스에 자주 쓰이는 Redis에 대해 알아보자](https://youtu.be/M2u3pOT7I8E?si=c_joluUfy1FRgPiA)
...
**Reddit**
- [계층 댓글에 대해](https://www.reddit.com/r/SQL/comments/ohoaov/how_to_implement_hierarchical_data_like_reddit/?tl=ko) 
